...
static func copy_base_stats(original: Stats.BaseStats) -> Stats.BaseStats:
...
static func copy_mapping_stats(original: Stats.MappingStats) -> Stats.MappingStats:
...
static func copy_stats_status_effects(original: Dictionary):
	var res = {}
...
static func copy_skills_store(original: PartyMember.SkillsStore) -> PartyMember.SkillsStore:
...
static func copy_equipment_slot(original: CharacterClass.Equipment_Slot) -> CharacterClass.Equipment_Slot:
	var res:= CharacterClass.Equipment_Slot.new(original.slot_types, original.equipment_id, original.max_cost)

	return res

static func copy_equipment_slot_array(original: Array[CharacterClass.Equipment_Slot]) -> Array[CharacterClass.Equipment_Slot]:
