...
func on_party_initialized():
	...
	var test_1 = Party.get_character("P_1").stats.combat_stats.physical.attack == 15
	...
	var test_2 = Party.get_character("P_1").stats.combat_stats.physical.attack == 5
	# print("")
	...
	var test_3 = Party.get_character("P_1").stats.combat_stats.physical.attack == 6
	# print("")
	...
	var test_4 = Party.get_character("P_1").stats.combat_stats.physical.attack == 18
	# print("")
	...
	var test_5 = Party.get_character("P_1").stats.combat_stats.physical.attack == 19.5
	# print("")
	...
	var test_6 = Party.get_character("P_1").stats.mapping_stats.intelligence == 80
	# print("")
	...
	Party.DICTIONARY.P_1.class_id = "BC_0"
	var test_7 = Party.get_character("P_1").stats.mapping_stats.intelligence == 6
	# print("")
